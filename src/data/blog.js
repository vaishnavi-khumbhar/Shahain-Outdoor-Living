...
export const blogPosts = [
  {
    ...
    title:
      "Choosing the Right Outdoor Furniture Material for Pune's Climate",
    ...
    image: blogImages[
      "choosing-outdoor-furniture-material-pune-climate"
    ],
...

  {
    ...
    image: blogImages["retractable-vs-fixed-awnings"],
...

  {
    ...
    image: blogImages[
      "caring-for-shade-sails-through-the-monsoon"
    ],
...

  {
    ...
    title:
      "Outdoor Umbrellas for Restaurants and Cafes: A Buyer's Guide",
    ...
    image: blogImages[
      "outdoor-umbrellas-for-restaurants-and-cafes"
    ],
...

  {
    ...
    title:
      "Why Hotels Choose Tensile Structures for Outdoor Seating",

    category: "Tensile Structures",

    readTime: "3 min read",

    image: blogImages["why-hotels-choose-tensile-structures"],
...

  {
    ...
    image: blogImages["styling-a-small-balcony-or-terrace"],
