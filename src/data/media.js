...
export const blogImages = {
  furniture: blogFurniture,
  awnings: blogAwnings,
  shadeSails: blogShadeSails,
  umbrellas: blogUmbrellas,
  tensile: blogTensile,
  balcony: blogBalcony,
};
...
export const media = {
  ...
  umbrellaGallery: outdoorUmbrellasImage,
  umbrellasMenu: outdoorUmbrellasImage,

  shadeSail: shadeSailsImage,
  shadeSailOverview: shadeSailsImage,
  shadeSailGallery: shadeSailsImage,
  shadeSailsMenu: shadeSailsImage,

  tensileStructure: tensileStructuresImage,
  tensileOverview: tensileStructuresImage,
  tensileGallery: tensileStructuresImage,
  tensileStructuresMenu: tensileStructuresImage,
};